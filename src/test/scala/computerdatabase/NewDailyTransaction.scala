 ...
 // setUp(profileAmendmentEPFNoScenario.inject(atOnceUsers(1))).protocols(httpProtocol)
  ...
  setUp(
    ...
    LeaveEmployeeApproverListingS.inject(rampUsers(HRNo).during(scriptDuration.minutes))
      ...
      .andThen(
        supWorkflowLeaveSaveScenario.inject(rampUsers(HRNo).during(scriptDuration.minutes)),
        supWorkflowLeaveResetScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supWorkflowLeaveRejectScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supWorkflowLeaveApproveScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supWorkflowClaimSaveScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supWorkflowClaimResetScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supWorkflowClaimRejectScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supWorkflowClaimApproveScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supDelegationSaveScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supDelegationResetScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supDelegationDeleteScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        massLeaveApplicationScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        massApprovalLeaveCancellationScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supEprofileChangeApproveScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supEprofileChangeSaveScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supEprofileChangeRejectScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        supEprofileChangeResetScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        MyTeamViewClaimEntitlementScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        MyTeamViewLeaveEntitlementScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        MyTeamViewLeaveApplicationScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        MyTeamViewClaimApplicationScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        applyLeaveDeleteDraftScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        empApplyClaimDeleteDraftScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        myProfileDeleteDraftScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        documentDeleteScenario.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        LeaveApplicationReportListingS.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        LeaveEntitlementReportListingS.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        ClaimApplicationReportListingS.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        ExpensesDetailsforFinanceListingS.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        ExpensesDetailsforClaimListingS.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        EmployeeLeaveBalanceReportS.inject(rampUsers(EMPNo).during(scriptDuration.minutes)),
        ClaimEntitlementReportS.inject(rampUsers(EMPNo).during(scriptDuration.minutes))
