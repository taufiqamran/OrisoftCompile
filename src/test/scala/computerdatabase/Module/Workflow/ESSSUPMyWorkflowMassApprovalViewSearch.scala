...
object ESSSUPMyWorkflowMassApprovalViewSearch {
  ...
  def loadApplication = {
    exec(http("My Workflow Mass Approval Page")
      ...
      .exec(http("request_83")
        .get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1620184143865")
      )
      .exec(http("request_84")
        .get("/Notifications/GetNotificationCounts")
      )
      .pause(329.milliseconds)
  ...
  def MAprrovalLst = {
    exec(http("MassApprovalLeaveListing")
      ...
      .pause(917.milliseconds)
      .exec(http("request_90")
        .get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=j%2FSZ07ZNK3fIR2x3co9KyZOYYj3CI1g0X%2FIvrE%2BFTJkadtyPK4ZMvkTgTzwXeTJrKCoNkqjL2haAi%2BmUo1CMs1pHZSAvz%2FW1aDBblzKLsDgP2xihDMWL9TzpHbAAMQ645UmEWwKlvqYEFuE%2FF4ijujB8OJXiFWYjJvy2o1y%2FdqA%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1620184143866")
      )
      .pause(2)
      .exec(http("request_91")
        .get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FMassApproval%2FMassApprovalListing&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._opi7tk&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=27938")
      )
      .pause(4)
      ...
      .exec(http("request_93")
        ...
        .formParam("CustomSearchParameters[0][Name]", "LeaveDateFrom")
        .formParam("CustomSearchParameters[0][Value]", "2021/05/26")
        .formParam("CustomSearchParameters[1][Name]", "LeaveDateTo")
        .formParam("CustomSearchParameters[1][Value]", "2021/05/27")
        .formParam("CustomSearchParameters[2][Name]", "SubmissionDateFrom")
        .formParam("CustomSearchParameters[2][Value]", "")
        .formParam("CustomSearchParameters[3][Name]", "SubmissionDateTo")
        .formParam("CustomSearchParameters[3][Value]", "")
