...
object ESSEMPMyWorkflowViewClaim {
  ...
  def searchCritCA = {
    exec(http("Search Request Form Based on Criteria")
      ...
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrCriteria$txtStatus", "Pending; Approved; Withdrawn; Rejected")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrCriteria$cbStatus$0", "P")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrCriteria$cbStatus$2", "W")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrCriteria$cbStatus$1", "A")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrCriteria$cbStatus$3", "R")
  ...
  def viewCA = {
    exec(http("request_41")
      ...
      .exec(http("request_55")
        .get("/signalr/negotiate?clientProtocol=2.1&userid=KM00562&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1623002766023")
      )
      .pause(881.milliseconds)
      .exec(http("request_56")
        .get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00562&connectionToken=biw3egyTwNWQg98KIhCJCMOgJvQtqVDG0dBMSS6cJIuoeHRzYDWPSy9o4fx9Kf9THThNEv8m0k880xIvSTWj5JMIK3NAO6mRzrJC818V6Ef5A4%2FYY01Trj49Ogr5M2ftS%2BXCUUWjOCFPDdY%2Bzso%2BPiDdjCipmRHtfxAjzmDBOD4%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1623002766024")
      )
      .pause(3)
      .exec(http("request_57")
        .get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FClaim%2FClaimApplicationW%3FValue%&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._8i0v0&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=77556")
      )
      .pause(808.milliseconds)
      .exec(http("request_58")
        .get(uri4 + "?family=Open+Sans:300,400,600,700")
      )
      .exec(http("request_59")
      ...
      .exec(http("request_69")
        .get("/Notifications/ViewNotifications?type=OzYXatY3Wc/zsrs1n0rWs77ykiKE2Y7MJ4Qlgn6wXTXPNmqYPSbVQucexs1D/GFw6DNnX74Uw8wbQIDXsnPdPE0qRjRBQW84fSCtnjEP+1nkPK6YGjXiQfWvi6+jyl+Mpunb9Oufmk6PKMwUDuM/28AO+TMAekxoRkSn2arJc6E=")
      )
      .exec(http("request_70")
        .get(uri3 + "?v=4.7.0")
      )
