...
class PayrollUploadAdol extends Simulation {
	...
	val chain_0 = exec(http("request_0")
		...
		.exec(http("request_35")
			.get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1623913101467")
			)
		.pause(2)
		.exec(http("request_36")
			.get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=E5IqKYZ3o3OhketJDm67qEy%2FMx64xK3pix9bh9LECIPi4aos%2F%2FXUbTLbZdEGJ0%2Fo3CWjROPRviaT332ZSyYYkBKA4KqIRuSIP5QKqcDDAkRE1Hd%2B3CrPVihq6qnHZB5FP5eH99JxFqxUI2TKrnvOyxZ%2BQ%2FNYC6FAhed3uhahXoc%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1623913101468")
			)
		...
		.exec(http("Upload 1")
			...
			.check(regex("state=\"(.+?)\"").saveAs("stateKe" +
				"y"))
...
val chain_1 = exec(http("request_86")
	...
	val scn = scenario("PayrollUploadAdol").exec(
		chain_0,chain_1)
